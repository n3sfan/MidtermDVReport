\section{Giới thiệu dữ liệu, phân tích bài toán}
...
\subsubsection{Dữ liệu nến giá (Kline) \cite{binance_klines}}
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|}
\hline
...
\subsubsection{Dữ liệu lệnh thanh lý \cite{binance_liquidation}}
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|}
\hline
...
- Ngữ cảnh dữ liệu: dữ liệu nến, thanh lý, các chỉ số khác (OI, ...) của thị trường các coin crypto trên Binance

- Người sử dụng: các trader, nhà phân tích theo dõi, giám sát thị trường

- Mục tiêu: Theo dõi, giám sát thị trường. Biết được thị trường hoạt động như thế nào tại thời điểm hiện tại và trong quá khứ.